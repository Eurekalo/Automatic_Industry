...
Write-Host "=== 1. Building Release Assembly with ILRepack ($Version) ==="
...
Write-Host "=== 2. Creating Release Folder (AutomaticIndustry-$Version) ==="
$relFolder = Join-Path $WorkspaceRoot "AutomaticIndustry-$Version"
...
Write-Host "=== 3. Creating Source Folder (AutomaticIndustry-src-$Version) ==="
$srcPkgFolder = Join-Path $WorkspaceRoot "AutomaticIndustry-src-$Version"
