...
# Clean up any leftover uncompressed ModMenu release folders
...
Copy-Item -Path (Join-Path $srcFolder "FRAMEWORK_ARCHITECTURE.md") -Destination (Join-Path $tempSrc "FRAMEWORK_ARCHITECTURE.md")
Copy-Item -Path (Join-Path $srcFolder "ARCHITECTURE_AUDIT.md") -Destination (Join-Path $tempSrc "ARCHITECTURE_AUDIT.md")
