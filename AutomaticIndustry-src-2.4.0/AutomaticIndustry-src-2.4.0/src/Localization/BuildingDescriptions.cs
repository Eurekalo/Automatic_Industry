...
namespace AutoMachineRebuilt.Localization
{
    ...
    internal static class BuildingDescriptions
    {
        ...
        internal static readonly Dictionary<string, string> DescriptionsEnglish = new Dictionary<string, string>
        {
            ...
            { "BUILDINGDESC.DLC1COSMICRESEARCHCENTER", "Vanilla: converts collected data into orbital research points. Automation runs only while data and an active research target exist." },
            ...
            { "BUILDINGDESC.GEYSERSTUDY", "Vanilla: a scientist Duplicant studies an uncovered geyser to analyze its eruption cycles. Automation completes the field study automatically once uncovered." },
            ...
            { "BUILDINGDESC.LIQUIDVALVE", "Vanilla: after changing the flow setting a Duplicant has to walk over and turn the valve before the new value applies. Automation applies the new flow immediately and cancels the pending valve chore." },
            { "BUILDINGDESC.GASVALVE", "Vanilla: after changing the flow setting a Duplicant has to walk over and turn the valve before the new value applies. Automation applies the new flow immediately and cancels the pending valve chore." },
        ...
        internal static readonly Dictionary<string, string> DescriptionsChineseSimplified = new Dictionary<string, string>
        {
            ...
            { "BUILDINGDESC.DLC1COSMICRESEARCHCENTER", "原版：将收集的数据转换为轨道研究。自动化在存有数据且存在有效研究目标时自动运行。" },
            ...
            { "BUILDINGDESC.GEYSERSTUDY", "原版：科学家实地研究已露出的间歇泉以分析其喷发周期。自动化会在间歇泉露出后自动完成野外勘探。" },
            { "BUILDINGDESC.VALVE", "原版：修改流量后需要复制人前往手动调节阀门，新数值才会生效。自动化立即应用新的流量并取消待处理的阀门任务。" },
            { "BUILDINGDESC.LIQUIDVALVE", "原版：修改流量后需要复制人前往手动调节阀门，新数值才会生效。自动化立即应用新的流量并取消待处理的阀门任务。" },
            { "BUILDINGDESC.GASVALVE", "原版：修改流量后需要复制人前往手动调节阀门，新数值才会生效。自动化立即应用新的流量并取消待处理的阀门任务。" },
        ...
        internal static readonly Dictionary<string, string> DescriptionsChineseTraditional = new Dictionary<string, string>
        {
            ...
            { "BUILDINGDESC.DLC1COSMICRESEARCHCENTER", "原版：將收集的數據轉換為軌道研究。自動化在存有數據且存在有效研究目標時自動運行。" },
            ...
            { "BUILDINGDESC.GEYSERSTUDY", "原版：科學家實地研究已露出的間歇泉以分析其噴發週期。自動化會在間歇泉露出後自動完成野外勘探。" },
            { "BUILDINGDESC.VALVE", "原版：修改流量後需要複製人前往手動調節閥門，新數值才會生效。自動化立即套用新的流量並取消待處理的閥門任務。" },
            { "BUILDINGDESC.LIQUIDVALVE", "原版：修改流量後需要複製人前往手動調節閥門，新數值才會生效。自動化立即套用新的流量並取消待處理的閥門任務。" },
            { "BUILDINGDESC.GASVALVE", "原版：修改流量後需要複製人前往手動調節閥門，新數值才會生效。自動化立即套用新的流量並取消待處理的閥門任務。" },
        ...
        internal static readonly Dictionary<string, string> DescriptionsKorean = new Dictionary<string, string>
        {
            ...
            { "BUILDINGDESC.DLC1COSMICRESEARCHCENTER", "바닐라: 수집한 데이터를 궤도 연구로 변환합니다. 자동화에는 데이터와 유효한 연구 목표가 필요합니다." },
            ...
            { "BUILDINGDESC.GEYSERSTUDY", "바닐라: 과학자 복제체가 노출된 간헐천을 연구하여 분출 주기를 분석합니다. 자동화는 간헐천 노출 시 야외 탐사를 자동으로 완료합니다." },
            { "BUILDINGDESC.VALVE", "기본: 유량을 변경하면 복제인이 밸브를 조작해야 새 값이 적용됩니다. 자동화는 새 유량을 즉시 적용하고 대기 중인 밸브 작업을 취소합니다." },
            { "BUILDINGDESC.LIQUIDVALVE", "기본: 유량을 변경하면 복제인이 밸브를 조작해야 새 값이 적용됩니다. 자동화는 새 유량을 즉시 적용하고 대기 중인 밸브 작업을 취소합니다." },
            { "BUILDINGDESC.GASVALVE", "기본: 유량을 변경하면 복제인이 밸브를 조작해야 새 값이 적용됩니다. 자동화는 새 유량을 즉시 적용하고 대기 중인 밸브 작업을 취소합니다." },
        ...
        internal static readonly Dictionary<string, string> DescriptionsJapanese = new Dictionary<string, string>
        {
            ...
            { "BUILDINGDESC.DLC1COSMICRESEARCHCENTER", "バニラ：収集したデータを軌道研究に変換します。自動化にはデータと有効な研究対象が必要です。" },
            ...
            { "BUILDINGDESC.GEYSERSTUDY", "バニラ：科学者複製人間が露出した間欠泉を現地調査して噴出周期を分析します。自動化により、間欠泉の露出後に現地調査が自動完了します。" },
            { "BUILDINGDESC.VALVE", "通常：流量を変更しても、複製人がバルブを操作するまで新しい値は適用されません。自動化は新しい流量を即座に適用し、保留中のバルブ作業を取り消します。" },
            { "BUILDINGDESC.LIQUIDVALVE", "通常：流量を変更しても、複製人がバルブを操作するまで新しい値は適用されません。自動化は新しい流量を即座に適用し、保留中のバルブ作業を取り消します。" },
            { "BUILDINGDESC.GASVALVE", "通常：流量を変更しても、複製人がバルブを操作するまで新しい値は適用されません。自動化は新しい流量を即座に適用し、保留中のバルブ作業を取り消します。" },
